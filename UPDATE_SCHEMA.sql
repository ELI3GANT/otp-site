...
-- ATOMIC INCREMENT FUNCTION (Unique Tracking handled via JS + this)
...
-- INSERT MISSING BLOG POSTS (Architecture)
...
-- INSERT MISSING BLOG POSTS (Beyond the Edit)
INSERT INTO posts (title, slug, excerpt, content, published, category, image_url, views)
VALUES (
...
-- INSERT MISSING BLOG POSTS (Vision to Strategy)
INSERT INTO posts (title, slug, excerpt, content, published, category, image_url, views)
VALUES (
...
-- INSERT SPOOKY LUH OOKY (Ensure it exists)
INSERT INTO posts (title, slug, excerpt, content, published, category, image_url, views)
VALUES (
  'Spooky: Luh Ooky',
  'spooky-luh-ooky',
