...
const publicTargets = [
  ...
  { name: 'bookings', path: '/bookings', kind: 'html', markers: ['/bookings.css', '/bookings.js', 'canonical', 'otp-logo-transparent.png'] },
  ...
  { name: 'privacy', path: '/privacy', kind: 'html', markers: ['Privacy', 'OnlyTruePerspective'] },
  { name: 'terms', path: '/terms', kind: 'html', markers: ['Terms', 'OnlyTruePerspective'] },
  { name: 'archive', path: '/archive', kind: 'html', markers: ['Archive', 'OnlyTruePerspective'] },
  { name: 'payment-success', path: '/payment-success', kind: 'html', markers: ['payment', 'success'] },
