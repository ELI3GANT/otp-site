...
(async () => {
    ...
    assert.equal(verifyPinnedContracts(repositoryRoot).contracts, 4);
    ...
    assert.match(JOB_ARCHIVE_CONTRACT_DIGEST, /^sha256:[a-f0-9]{64}$/);
    assert.equal(JOB_ARCHIVE_CONTRACT_VERSION, 'otp-job-archive-v1');
