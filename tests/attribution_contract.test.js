...
assert.ok(indexHtml.includes('otp-attribution.js?v=16.9.0'), 'homepage loads attribution helper');
assert.ok(siteInit.includes('OTPAttribution.captureOnLoad'), 'site-init captures attribution on load');
assert.ok(bookingsHtml.includes('otp-attribution.js?v=16.9.0'), 'bookings page loads attribution helper');
